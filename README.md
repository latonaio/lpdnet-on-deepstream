...
## engineファイルについて
engineファイルである lpdnet_usa.engine は、[lpdnet-on-tao-toolkit](https://github.com/latonaio/lpdnet-on-tao-toolkit)と共通のファイルであり、当該レポジトリで作成した engineファイルを、本リポジトリで使用しています。  
